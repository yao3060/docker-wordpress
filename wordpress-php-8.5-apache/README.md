# WordPress PHP 8.5 Apache 镜像说明

基于 `php:8.5-apache` 构建，适用于 WordPress 运行环境，内置常用 PHP 扩展、Apache 模块和运维工具。
...
```bash
docker build -t wordpress:php8.5-apache .
```
